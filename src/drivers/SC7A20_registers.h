...
#define CTRL_REG2_FDS       (1 << 3) // Data filtering options. Defaults: 0. (0: skip internal filtering; 1: The data after internal filtering is output to the data register or FIFO)
...
#define CTRL_REG4_BLE   (1 << 6) // Big endian/little endian data selection. Defaults:0 (0: The low byte data is at the low address; 1: high byte data at low address)
#define CTRL_REG4_BDU   (1 << 7) // Block data update. Defaults: 0. (0: continuous update; 1: The output data register is not updated until MSB and LSB is read)
...
#define CTRL_REG5_D4D_INT2  (1 << 0) // 4D enable: in INT2 enable on pin 4D detection, while taking the interrupt2 in the configuration register 6D set 1.
#define CTRL_REG5_LIR_INT2  (1 << 1) // Latch Interrupt2 The interrupt response specified on the configuration register. Interrupt by read 2 The configuration register can clear the corresponding interrupt latch signal. Defaults: 0 (0: Do not latch the interrupt signal; 1: Latch interrupt signal)
#define CTRL_REG5_D4D_INT1  (1 << 2) // 4D enable: in INT1 enable on pin 4D detection, while taking the interrupt1 in the configuration register 6D set 1.
#define CTRL_REG5_LIR_INT1  (1 << 3) // Latch Interrupt1 The interrupt response specified on the configuration register. Interrupt by read 1 The configuration register can clear the corresponding interrupt latch signal. Defaults: 0 (0: Do not latch the interrupt signal; 1: Latch interrupt signal)
#define CTRL_REG5_FIFO_EN   (1 << 6) // FIFO Enable. Defaults: 0. (0: FIFO prohibit; 1: FIFO Enable)
#define CTRL_REG5_BOOT      (1 << 7) // Override trim value. Defaults: 0. (0: normal mode; 1: Overload trim value)
...
#define STATUS_REG_XDA      (1 << 0) // X New data for the axis arrives. Defaults: 0 (0: X The new data of the axis has not been converted; 1: X Axis new data conversion completed)
#define STATUS_REG_YDA      (1 << 1) // Y New data for the axis arrives. Defaults: 0 (0: Y The new data of the axis has not been converted; 1: Y Axis new data conversion completed)
#define STATUS_REG_ZDA      (1 << 2) // Z New data for the axis arrives. Defaults: 0 (0: Z The new data of the axis has not been converted; 1: Z Axis new data conversion completed)
#define STATUS_REG_ZYXDA    (1 << 3) // X, Y and Z The new data of the three axes are all converted. Defaults: 0 (0: The data of at least one of the three axes has not been converted; 1: The new data of the three axes are all converted)
#define STATUS_REG_XOR      (1 << 4) // X The new data of the axis has overwritten the old data. Defaults: 0. (0: X The new data of the axis has not overwritten the old data; 1: X The new data of the axis overwrites the old data)
#define STATUS_REG_YOR      (1 << 5) // Y The new data of the axis has overwritten the old data. Defaults: 0. (0: Y The new data of the axis has not overwritten the old data; 1: Y The new data of the axis overwrites the old data)
#define STATUS_REG_ZOR      (1 << 6) // Z The new data of the axis has overwritten the old data. Defaults: 0. (0: Z The new data of the axis has not overwritten the old data; 1: Z The new data of the axis overwrites the old data)
#define STATUS_REG_ZYXOR    (1 << 7) // X, Y and Z At least one of the new data on the three axes has overwritten the old data. Defaults: 0 .(0: The new data of none of the three axes overwrites the old data; 1: The new data of at least one of the three axes has overwritten the old data)
...
#define FIFO_SRC_REG_EMPTY      (1 << 5) // Set high when all FIFO samples have been read and the FIFO is empty
#define FIFO_SRC_REG_OVRN_FIFO  (1 << 6) // Set high when the FIFO buffer is full, which means that the FIFO buffer contains 32 unread samples
...
#define INT1_CFG_XLIE_XDOWNE    (1 << 0) // X Axis low event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT1_CFG_XHIE_XUPE      (1 << 1) // X Axis high event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT1_CFG_YLIE_YDOWNE    (1 << 2) // Y Axis low event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT1_CFG_YHIE_YUPE      (1 << 3) // Y Axis high event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT1_CFG_ZLIE_XDOWNE    (1 << 4) // Z Axis low event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT1_CFG_ZHIE_ZUPE      (1 << 5) // Z Axis high event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT1_CFG_6D             (1 << 6) // 6 The direction detection function is enabled. Defaults: 0. Refer to "Interrupt Mode"
#define INT1_CFG_AOI            (1 << 7) // and/or interrupt events. Defaults: 0. Refer to "Interrupt Mode"
...
#define INT1_SOURCE_IA  (1 << 6) // Interrupt activation. Defaults: 0. (0: Interrupt is not generated; 1: one or more interrupts have been generated)
...
#define INT1_DURATION_D0    (1 << 0) // Duration count value. Defaults: 000 0000. set recognized interrupt The minimum duration of the event. The maximum time and time step of the duration register is ODR for the clock.
...
#define INT2_CFG_XLIE_XDOWNE    (1 << 0) // X Axis low event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT2_CFG_XHIE_XUPE      (1 << 1) // X Axis high event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT2_CFG_YLIE_YDOWNE    (1 << 2) // Y Axis low event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT2_CFG_YHIE_YUPE      (1 << 3) // Y Axis high event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT2_CFG_ZLIE_XDOWNE    (1 << 4) // Z Axis low event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT2_CFG_ZHIE_ZUPE      (1 << 5) // Z Axis high event interrupt or Z Axis Orientation Detection Interrupt Enable. Defaults: 0 (0: disable interrupt; 1: enable interrupt)
#define INT2_CFG_6D             (1 << 6) // 6 The direction detection function is enabled. Defaults: 0. Refer to "Interrupt Mode"
#define INT2_CFG_AOI            (1 << 7) // and/or interrupt events. Defaults: 0. Refer to "Interrupt Mode"
...
#define INT2_SOURCE_IA  (1 << 6) // Interrupt activation. Defaults: 0. (0: Interrupt is not generated; 1: one or more interrupts have been generated)
...
#define INT2_DURATION_D0    (1 << 0) // Duration count value. Defaults: 000 0000. set recognized interrupt The minimum duration of the event. The maximum time and time step of the duration register is ODR for the clock.
...
#define CLICK_CFG_XS    (1 << 0) // Enable interrupt single tap on X axis. Default value: 0. (0: disable interrupt request; 1: enable interrupt request on measured accel. value higher than preset threshold)
#define CLICK_CFG_XD    (1 << 1) // Enable interrupt double tap on X axis. Default value: 0. (0: disable interrupt request; 1: enable interrupt request on measured accel. value higher than preset threshold)
#define CLICK_CFG_YS    (1 << 2) // Enable interrupt single tap on Y axis. Default value: 0. (0: disable interrupt request; 1: enable interrupt request on measured accel. value higher than preset threshold)
#define CLICK_CFG_YD    (1 << 3) // Enable interrupt double tap on Y axis. Default value: 0. (0: disable interrupt request; 1: enable interrupt request on measured accel. value higher than preset threshold)
#define CLICK_CFG_ZS    (1 << 4) // Enable interrupt single tap on Z axis. Default value: 0. (0: disable interrupt request; 1: enable interrupt request on measured accel. value higher than preset threshold)
#define CLICK_CFG_ZD    (1 << 5) // Enable interrupt double tap on Z axis. Default value: 0. (0: disable interrupt request; 1: enable interrupt request on measured accel. value higher than preset threshold)
...
#define CLICK_SRC_SCLICK    (1 << 4) // Single Click-Click enable. Default value: 0. (0:Single Click-Click detection disable, 1: single Click-Click detection enable)
#define CLICK_SRC_DCLICK    (1 << 5) // Single Click-Click enable. Default value: 0. (0:Single Click-Click detection disable, 1: single Click-Click detection enable)
#define CLICK_SRC_IA        (1 << 6) // Interrupt active. Default value: 0. (0: no interrupt has been generated; 1: one or more interrupts have been generated)
...
#define CLICK_THS_LIR_CLICK    (1 << 7) // If the LIR_Click bit is not set, the interrupt is kept high for the duration of the latency window. If the LIR_Click bit is set, the interrupt is kept high until CLICK_SRC (39h) is read
...
#define ACT_THS_ACTH0   (1 << 0) // Sleep to wake, return to Sleep activation threshold in Low power mode (1LSb = 16mg @FS=2g, 1LSb = 32 mg @FS=4g, 1LSb = 62 mg @FS=8g, 1LSb = 186 mg @FS=16g)
